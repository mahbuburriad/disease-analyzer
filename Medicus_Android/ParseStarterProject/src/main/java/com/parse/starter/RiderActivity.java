...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void checkForUpdates() {
        ...
        query.whereExists("doctorUsername");
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                ...
                if (e == null && objects.size() > 0) {
                    ...
                    query.whereEqualTo("username", objects.get(0).getString("doctorUsername"));
                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInMiles < 0.01) {
                                            ...
                                            infoTextView.setText("Your doctor is here!");
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callUberButton.setText("Call A Doctor");
                                                    requestActive = false;
                                                    driverActive = false;
                                            ...
                                            infoTextView.setText("Your doctor is " + distanceOneDP.toString() + " miles away!");
                                            ...
                                            markers.add(mMap.addMarker(new MarkerOptions().position(driverLocationLatLng).title("Doctor Location")));
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    ...
                    if (e == null) {
                        ...
                        if (objects.size() > 0) {
                            ...
                            requestActive = false;
                            callUberButton.setText("Call An Doctor");
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callUberButton.setText("Cancel Doctor");
                                requestActive = true;
