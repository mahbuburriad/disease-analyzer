				...
				<div class="row">
					<aside class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ftr-widget ftr-widget-about">
						<div class="footer-logo"> 
							<a href="#"><img class="logo" src="images/logo-white.png" alt="Logo Footer"> Medicus</a>
						</div>
						<p>A medical friend  to you. want to serve you 24/7 and give you a nice healthy life</p>
						<ul>
							<li><i class="icon_pin"></i> 1234 Bashundhara Baridhara, Dhaka, Bangladesh </li>
							<li><i class="icon_mail_alt"></i> <a href="mailto:info@medicus.ml">info@medicus.ml</a> </li>
							<li><i class="icon_phone"></i> <a href="tel:+8801711574805">(+880) 1711574805</a> </li>
						</ul>
					</aside>
